const { ChatInputCommandInteraction, ChannelType, PermissionFlagsBits, TextChannel, EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, Colors } = require('discord.js')
...
module.exports = async (interaction) => {
    ...
    if(interaction.customId === 'claim') {
        ...
        interaction.reply({
            embeds: [
                new EmbedBuilder()
                .setDescription('<:verified:1118650085010587688> **You have sucessfull claimed the ticket.**')
    ...
    if(interaction.customId === 'unclaim') {
        ...
        interaction.reply({
            embeds: [
                new EmbedBuilder()
                .setDescription('<:verified:1118650085010587688> **You have sucessfull unclaimed the ticket.**')
                .setColor(Colors.Green)
            ],
            ephemeral: true
        })
